...
// //commitVS#forks + authorVS#forks + timeVS#commits (global and per fork) +
// commitRankVS(commit|author totals)
// @SuppressWarnings("rawtypes")
// static void createDataFiles(FeatureList fl) throws IOException, IllegalArgumentException,
...
// fileCos.close();
//
// fileCorr = new BufferedWriter(new FileWriter(GitWorks.trees_out_dir + "PCA_ALLTREES.corr",
// false));
...
// fileCorr.write(GitWorks.field_sep + co.correlation(Arrays.copyOf(a1, k), Arrays.copyOf(a2, k)));
// // correlation(diff[j],
// // cosims[j])
// }
// fileCorr.newLine();
...
// fileCorr.close();
//
// fileData = new BufferedWriter(new FileWriter(GitWorks.trees_out_dir + "PCA_ALLTREES.data",
// false));
